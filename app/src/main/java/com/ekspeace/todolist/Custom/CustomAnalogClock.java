package com.ekspeace.todolist.Custom;
...
public class CustomAnalogClock extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!isInit) {
            ...
            mHeight = getHeight();
            mWidth = getWidth();
            mPadding = mNumeralSpacing + 25;  // spacing from the circle border
        ...
        /** circle border */
        mPaint.reset();
        mPaint.setColor(Color.parseColor("#68C0FB"));
        ...
        canvas.drawCircle(mWidth / 2, mHeight / 2, 6, mPaint);  // the 03 clock hands will be rotated from this center point.
    ...
    private void drawHandLine(Canvas canvas, double moment, boolean isHour, boolean isSecond) {
        ...
        if (isSecond) mPaint.setColor(Color.parseColor("#68C0FB"));
